...
export type AudioClip = {
  ...
  contentTypeHuman: Scalars['String'];
  fileName: Scalars['String'];
  fileSize: Scalars['Int'];
  fileSizeHuman: Scalars['String'];
...
export type RoundTimersArgs = {
  ...
  includeMatchTimers?: InputMaybe<Scalars['Boolean']>;
...
export type SingleEliminationEvent = Event & {
  ...
  maximumNumberOfRounds: Scalars['Int'];
  name: Scalars['String'];
  /** Calculates the number of players in a given round. */
  numberOfPlayersInRound: Scalars['Int'];
...
export type SingleEliminationEventCreateInput = {
  ...
  pairingMode: SingleEliminationPairingMode;
  swissEventId: Scalars['ID'];
  swissPlayerIds: Array<Scalars['ID']>;
};
...
export type TimerCloneWithExtensionInput = {
  ...
  extensionInSeconds: Scalars['Int'];
...
export type TimerPhase = TimerPhaseable & {
  ...
  durationHumanized: Scalars['String'];
...
export type TimerPreset = {
  ...
  totalDurationHumanized: Scalars['String'];
  totalDurationInSeconds: Scalars['Int'];
};
...
export type TimerPresetPhaseInput = {
  ...
  durationAmount?: InputMaybe<Scalars['Int']>;
...
type CreateRoundButton_SingleEliminationEvent_Fragment = { __typename?: 'SingleEliminationEvent', id: string };

type CreateRoundButton_SwissEvent_Fragment = { __typename?: 'SwissEvent', id: string };

export type CreateRoundButtonFragment = CreateRoundButton_SingleEliminationEvent_Fragment | CreateRoundButton_SwissEvent_Fragment;
...
export type EventListFragment = { __typename?: 'EventConnection', nodes: Array<{ __typename?: 'SingleEliminationEvent', id: string, slug: string, name: string, deleted: boolean } | { __typename?: 'SwissEvent', id: string, slug: string, name: string, deleted: boolean }> };

type EventListItem_SingleEliminationEvent_Fragment = { __typename?: 'SingleEliminationEvent', id: string, name: string, slug: string, deleted: boolean };

type EventListItem_SwissEvent_Fragment = { __typename?: 'SwissEvent', id: string, name: string, slug: string, deleted: boolean };
...
export type RestoreEventMutation = { __typename?: 'Mutation', eventRestore?: { __typename?: 'EventRestorePayload', event?: { __typename?: 'SingleEliminationEvent', id: string, name: string, slug: string, deleted: boolean } | { __typename?: 'SwissEvent', id: string, name: string, slug: string, deleted: boolean } | null } | null };
...
export type RoundListItemMatchFragment = { __typename?: 'Round', id: string, number: number, isComplete: boolean, matches: Array<{ __typename?: 'Match', id: string, table: number, winnerId?: string | null, draw: boolean, timer?: { __typename?: 'Timer', matchId?: string | null, id: string, instant: string, expiresAt: string, pausedAt?: string | null, totalDurationInSeconds: number, phases: Array<{ __typename?: 'TimerPhase', id: string, name: string, position: number, durationInSeconds: number, offsetFromStart: number, offsetFromEnd: number, audioClip?: { __typename?: 'AudioClip', id: string, fileUrl: string } | null }> } | null, player1: { __typename?: 'Player', id: string, name: string, dropped: boolean, paid: boolean, deleted: boolean }, player2?: { __typename?: 'Player', id: string, name: string, dropped: boolean, paid: boolean, deleted: boolean } | null }>, primaryTimer?: { __typename?: 'Timer', id: string } | null };
...
export type EventsIndexQuery = { __typename?: 'Query', events: { __typename?: 'EventConnection', nodes: Array<{ __typename?: 'SingleEliminationEvent', id: string, slug: string, name: string, deleted: boolean } | { __typename?: 'SwissEvent', id: string, slug: string, name: string, deleted: boolean }> } };
...
export const UnpauseAllEventTimersDocument = gql`
    mutation UnpauseAllEventTimers($roundId: ID!) {
