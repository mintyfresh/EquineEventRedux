...
const Slip: React.FC<SlipProps> = ({ event, round, match }) => {
  return (
    <svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="600px"
      ...
      <text transform="matrix(1 0 0 1 35.5 37.624)" fontFamily="'MyriadPro-Regular'" fontSize="12">{match.player1.score ?? match.player1.winsCount} - {match.player1.name}</text>
      ...
      <text transform="matrix(1 0 0 1 35.5 69.1245)" fontFamily="'MyriadPro-Regular'" fontSize="12">{match.player2?.score ?? match.player2?.winsCount ?? 0} - {match.player2?.name ?? 'None'}</text>
