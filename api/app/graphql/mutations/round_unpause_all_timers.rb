...
module Mutations
  class RoundUnpauseAllTimers < BaseMutation
    argument :round_id, ID, required: true do
      description 'The ID of the round for which the timers should be unpaused.'
    end

    field :round, Types::RoundType, null: true do
      description 'The round for which the timers were unpaused.'
    end
    ...
    def resolve(round_id:)
      ...
      timers = round.timers.paused.lock
